      ...
      <div className="sticky top-0 z-50 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 p-4 shadow-xl">
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <div className="absolute -bottom-1 -right-1 bg-yellow-500 text-slate-950 font-black text-[10px] px-1 rounded border border-white">
              LV.{userStats.level}
            </div>
          </div>
          <div className="flex-1">
            <div className="flex justify-between items-end mb-1">
              <span className="text-[10px] font-bold text-yellow-500 uppercase tracking-widest">Experience Points</span>
